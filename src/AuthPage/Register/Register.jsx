...
const RegisterComponent = () => {
  ...
  return (
  <div className="register-container" style={{ backgroundImage: `url(${IMAGE.news1})` }}>
  <div className="container h-100 w-100">
    <div className="row justify-content-center">
      <div className="col-md-6">
        <div className="card">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="card-header bg-success text-light text-center fs-4 fw-bold">Đăng ký</div>
